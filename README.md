...
- pnpm v10+ (the `minimum-release-age` setting requires pnpm v10.16+)
...
`minimum-release-age` is a pnpm v10.16+ setting (value in minutes) that refuses to install any package version published less than 7 days ago (10080 minutes). This standardizes the "minimum release age" supply-chain rule so freshly published, potentially compromised or yanked releases are skipped automatically instead of being checked by hand.
